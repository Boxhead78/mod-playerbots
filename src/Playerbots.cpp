    ...
    void OnPlayerLogin(Player* player) override
    {
        if (!player->GetSession()->IsBot())
        {
            ...
            if (sPlayerbotAIConfig->enabled)
            {
                ...
                if (loc == 3)
                    ChatHandler(player->GetSession()).SendSysMessage("|cff00ff00Dieser Server nutzt |cff00ccffmod-playerbots|r ""|cffcccccchttps://github.com/mod-playerbots/mod-playerbots|r");
                else
                    ChatHandler(player->GetSession()).SendSysMessage("|cff00ff00This server runs with |cff00ccffmod-playerbots|r ""|cffcccccchttps://github.com/mod-playerbots/mod-playerbots|r");
            }
