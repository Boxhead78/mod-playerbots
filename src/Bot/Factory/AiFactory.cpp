...
void AiFactory::AddDefaultCombatStrategies(Player* player, PlayerbotAI* const facade, Engine* engine)
{
    ...
    if (player->InBattleground() && player->GetBattleground())
    {
        ...
        if (player->InArena())
        {
            ...
            engine->addStrategiesNoInit("boost", "racials", "chat", "default", "aoe", "cast time", "dps", "dps assist", nullptr);
        }
        else
            engine->addStrategiesNoInit("boost", "racials", "chat", "default", "aoe", "potions", "cast time", "dps", "dps assist", nullptr);
