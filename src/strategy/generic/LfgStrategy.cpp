...
{
    triggers.push_back(new TriggerNode("random lfg", NextAction::array(0, new NextAction("lfg join", relevance), nullptr)));
    triggers.push_back(new TriggerNode("random lfg leave", NextAction::array(0, new NextAction("lfg leave", relevance), nullptr)));
